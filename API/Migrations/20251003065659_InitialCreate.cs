        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NameCode = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TenLinhVuc = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_LinhVucs", x => x.LinhVucId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    KhoiId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TenKhoi = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    LinhVucId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Khois_LinhVucs_LinhVucId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BienChes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BienChes_Khois_KhoiId",
                        column: x => x.KhoiId,
                        principalTable: "Khois",
                        principalColumn: "KhoiId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BienChes_LinhVucs_LinhVucId",
                        column: x => x.LinhVucId,
                        principalTable: "LinhVucs",
                        principalColumn: "LinhVucId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BienChes_KhoiId",
                table: "BienChes",
                column: "KhoiId");

            migrationBuilder.CreateIndex(
                name: "IX_BienChes_LinhVucId",
                table: "BienChes",
                column: "LinhVucId");
