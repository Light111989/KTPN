...
namespace API.Migrations
{
    ...
    [Migration("20251013100538_AddBienCheHistory")]
    partial class AddBienCheHistory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Domain.BienChe", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("API.Domain.Khoi", b =>
                {
                    b.Property<Guid>("KhoiId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("API.Domain.LinhVuc", b =>
                {
                    b.Property<Guid>("LinhVucId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("API.Domain.Test", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("API.Domain.BienChe", b =>
                {
                    b.HasOne("API.Domain.Khoi", "Khoi")
                        .WithMany("BienChes")
                        .HasForeignKey("KhoiId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("API.Domain.LinhVuc", "LinhVuc")
                        .WithMany()
